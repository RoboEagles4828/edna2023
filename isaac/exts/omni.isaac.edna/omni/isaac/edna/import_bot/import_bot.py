...
class ImportBot(BaseSample):
    ...
    def setup_field(self):
        ...
        substation_1 = GeometryPrim("/World/Substation_1","substation_1_view",position=np.array([-7,-3.07,0.0]))
        substation_2 = GeometryPrim("/World/Substation_2","substation_2_view",position=np.array([7,-3.7,0.0]))
        substation_3 = GeometryPrim("/World/Substation_3","substation_3_view",position=np.array([7,3.7,0.0]))
        substation_4 = GeometryPrim("/World/Substation_4","substation_4_view",position=np.array([-7,3.7,0.0]))
