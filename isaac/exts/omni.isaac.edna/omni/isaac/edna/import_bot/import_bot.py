...
class ImportBot(BaseSample):
    ...
    def setup_field(self):
        ...
        substation = os.path.join(self.project_root_path, "assets/substation_01/substation_base.usd")
        ...
        substation_1 = GeometryPrim("/World/SubStation_1","substation_1_view",position=np.array([-12.4,-3.07,0.0]))
        substation_2 = GeometryPrim("/World/SubStation_2","substation_2_view",position=np.array([12.4,-3.7,0.0]))
