...
class ImportBot(BaseSample):
    ...
    def configure_robot(self, robot_prim_path):
        ...
        elevator_left_elevator_center_joint = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath(f"{robot_prim_path}/elevator_left_elevator_outer_1_link/elevator_left_elevator_center_joint"), "linear")
        elevator_left_elevator_outer_1_joint = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath(f"{robot_prim_path}/elevator_left_elevator_center_link/elevator_left_elevator_outer_2_joint"), "linear")
        ...
        elevator_right_elevator_center_joint = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath(f"{robot_prim_path}/elevator_right_elevator_outer_1_link/elevator_right_elevator_center_joint"), "linear")
        elevator_right_elevator_outer_1_joint = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath(f"{robot_prim_path}/arm_back_leg_link/elevator_right_elevator_outer_1_joint"), "angular")
        elevator_right_elevator_outer_2_joint = UsdPhysics.DriveAPI.Get(stage.GetPrimAtPath(f"{robot_prim_path}/elevator_right_elevator_center_link/elevator_right_elevator_outer_2_joint"), "linear")
