...
#include "arm_hardware/isaac_drive.hpp"
...
hardware_interface::return_type arm_hardware::IsaacDriveHardware::write(const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
...
PLUGINLIB_EXPORT_CLASS(
  arm_hardware::IsaacDriveHardware, hardware_interface::SystemInterface)