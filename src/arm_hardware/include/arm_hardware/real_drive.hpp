...
#ifndef ARM_HARDWARE__REAL_DRIVE_HPP_
#define ARM_HARDWARE__REAL_DRIVE_HPP_
...
private:
  ...
  // Pub Sub to isaac
  std::string joint_state_topic_ = "real_arm_joint_states";
  std::string joint_command_topic_ = "real_arm_joint_commands";
...
#endif  // ARM_HARDWARE__DIFFBOT_SYSTEM_HPP_