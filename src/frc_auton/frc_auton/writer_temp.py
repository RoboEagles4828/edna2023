...
class BagWriter(Node): 
    def __init__(self):
        ...
        self.srv = self.create_service(StartWriter, 'start_writer', self.start_service_writer)
        ...
        self.writer_arm.create_topic(topic_info_swerve)
    ...
    def start_service_writer(self, request, response):
